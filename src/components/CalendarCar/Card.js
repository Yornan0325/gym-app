                ...
                <div className="2xl:w-1/3 xl:w-1/2 lg:w-3/5 sm:w-4/5 w-full shadow-lg">
                    ...
                    <div className="md:py-8 py-5 md:px-16 px-5 dark:bg-gray-700 bg-primary bg-gray-50 rounded-b">
                        <ol class="relative border-s border-gray-200 dark:border-gray-700">
                            ...
                            <li class="mb-10 ms-4">
                                <div class=" absolute  w-5 h-5 bg-blue-700 rounded-full mt-1.5 -start-3 border border-blue-700 dark:border-gray-900 dark:bg-gray-700"></div>

                                <time class="mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">Hoy 2022</time>
                                <h1 class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">8:30-9:30</h1>
                                <h1 class="text-lg font-semibold text-gray-900 dark:text-white">Rutina de calentamiento</h1>
                                <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Inicia con la sesion de calentamiento y termina con un descanso</p>
                                {/* <a href={() => false} class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-100 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">Learn more <svg class="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
