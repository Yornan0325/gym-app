            ...
            <div class="flex rounded-lg w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-full max-w-sm min-w-64  p-2 m-2 flex-col shadow bg-slate-950 overflow-hidden hover:shadow-2xl group rounded-xl transition-all duration-500 transform">
                <div class="flex gap-4">
                    <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwyfHxhdmF0YXJ8ZW58MHwwfHx8MTY5MTg0NzYxMHww&ixlib=rb-4.0.3&q=80&w=1080"
                        class="w-20 m-2 h-20 group-hover:w-24 group-hover:h-24  object-center object-cover rounded-full transition-all duration-500 delay-500 transform"
                        alt="titulo"
                    />
                    <div class="w-fit transition-all transform duration-500 mt-5">
                        <h1 class="text-gray-600 dark:text-gray-200 font-bold">
                            {data.title} {data.surnames}
                        </h1>
                        {/* <h1 class="text-gray-400">  {data.title}</h1> */}
                ...
                {/* <div class="w-auto">
                                <h1 class="text-lg font-semibold text-gray-800 sm:text-xl">{items.content}</h1>
                                <p class="text-sm text-gray-500 md:text-base">Fotografer</p>
                                <p class="text-sm text-gray-800 md:text-base">Lorem ipsum dolor sit  </p>
                            </div> */}
                <ul class="py-2 mx-8 mt-2 text-gray-500 flex items-center justify-between">
