            ...
            {props.logoStaet ? (
              <>
                ...
                <div className="hidden md:block">
                  <div className="mx-2">
                    <h2 className="text-xl text-neutral-100">{props.name}</h2>
                  </div>
                </div>
              </>
            ) : (
              <>
                <div className="flex items-start mx-2 block text-base font-medium ">
                  <img
                    src={props.imgUser}
                    className={props.dimention + "  group-hover:w-24 group-hover:h-24  object-center object-cover rounded-full transition-all duration-500 delay-500 transform"}
                    alt="titulo"
                  />
                  <div className="  ">
                    <div className="mx-2">
