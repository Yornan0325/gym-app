...
export default function SignUpPage() {
    ...
    return (
        <>
            <div class=" max-w-lg px-4 mx-auto bg-gray-200 ">
                            ...
                            <form>
                                ...
                                {isFormValid() ?
                                    <button type="submit"
                                        ...
                                        Enviar
                                    </button> : <h1 class="mb-12 block text-base font-sm text-red-700 mt-2 relative block w-full px-2 py-2 text-center text-base text-red-700 bg-gray-900 rounded-lg font-regular">Por favor completa todos los campos</h1>
                                }
                            </form>
