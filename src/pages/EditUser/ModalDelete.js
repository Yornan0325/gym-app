...
export default function ModalDelete({ modal  , deleteUser, idUser }) {
                        ...
                        <div className="relative w-auto my-6 mx-auto max-w-3xl">
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="relative p-6 flex-auto">
                                    <p
                                    className="text-center text-gray-500 dark:text-gray-400 text-3xl md:text-3xl sm:text-3xl lg:text-base  text-gray-900 dark:text-white" 
                                ...
                                <div className="  flex justify-around  items-center justify-center p-6 border-t border-solid border-blueGray-200 rounded-b">
                                    ...
                                    <button onClick={() => deleteUser(idUser)} className="bg-red-500 text-white hover:bg-red-800 font-bold md:text-lg sm:text-lg  text-md px-3 py-2 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">
                                        Eliminar cuenta
                                    </button>
                                </div>
                            </div>
